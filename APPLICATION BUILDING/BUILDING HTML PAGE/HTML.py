...
Original file is located at
    https://colab.research.google.com/drive/1I42cd8aJBhdqiGyPLgXYitCpYWglVAOt
"""
...
<body>
    <nav class="navbar navbar-light navbar-expand-md py-3" style="background: #121212;">
        <div class="container">
            <div></div><a class="navbar-brand d-flex align-items-center" href="#"><span
                    class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><i
                        class="fas fa-flask"  style="color:#ffffff;"></i></span><span style="color: rgb(255,255,255);">Real-Time Communication
                    System Powered By AI&nbsp;For Specially Abled</span></a>
            <div></div>
        </div>
    </nav>
    <section style="background-image: url('https://img.freepik.com/free-vector/hand-sign-background-doodle-pattern-black-white-vector_53876-157748.jpg?w=740&t=st=1668366858~exp=1668367458~hmac=5e3fc702d27b9c82235eebd9c4e4ae26c8718196c48854abbf8dff28fc0c11b9');background-size: cover;
    ">
    <section>
        ...
        <div class="d-flex flex-column justify-content-center align-items-center" style="margin-bottom: 10px;"><button style="background: rgb(33,37,41);"
            ...
            <div class="accordion text-white" role="tablist" id="accordion-1">
                <div class="accordion-item" style="background: rgb(33,37,41);">
                    <h2 class="accordion-header" role="tab"><button class="accordion-button" data-bs-toggle="collapse"
                            ...
                            style="background: rgb(18,18,18);color: rgb(255,255,255);">About The Project</button></h2>
                ...
                <div class="accordion-item" style="background: rgb(33,37,41);">
                    <h2 class="accordion-header" role="tab"><button class="accordion-button collapsed"
                            ...
                            style="background: rgb(18,18,18);color: rgb(231,241,255);">Developed By</button></h2>
                    <div class="accordion-collapse collapse item-2" role="tabpanel" data-bs-parent="#accordion-1">
                        <div class="accordion-body">
                            <p class="mb-0">TEAM ID: PNT2022TMID01161
                                <br><br>1. <strong>Shanmugasri.S.N </strong> 211419106252 <br>2.
                                <strong>Priyenga.E</strong> 211419106207<br>3. <strong>Surudhika.J </strong> 211419106270<br>3. <strong>Tivona.S</strong> 211419106280
                            </p>
                        </div>
                    </div>
                </div>
